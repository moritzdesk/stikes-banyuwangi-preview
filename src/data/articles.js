export const articles = [
  {
    ...
    content: `
      ...
      <ul>
        <li>PKM Riset Eksakta (3 proposal)</li>
        <li>PKM Kewirausahaan (2 proposal)</li>
        <li>PKM Pengabdian Masyarakat (3 proposal)</li>
        <li>PKM Karsa Cipta (2 proposal)</li>
      </ul>
    ...
    tags: ['Prestasi', 'PKM', 'Penelitian', 'Mahasiswa']
  },
  {
    id: 2,
    title: 'Gelar KKN 2025: Pengabdian Masyarakat',
    category: 'KEGIATAN',
    ...
    content: `
      ...
      <ul>
        ...
        <li>Program sanitasi lingkungan</li>
  ...
  {
    id: 3,
    title: 'Workshop Penelitian Kesehatan',
    category: 'WORKSHOP',
    ...
    content: `
      ...
      <ul>
        <li>Metodologi penelitian kuantitatif dan kualitatif</li>
        <li>Teknik pengumpulan data</li>
        <li>Analisis data statistik</li>
        <li>Penulisan proposal penelitian</li>
  ...
  },
  {
    ...
    content: `
      ...
      <ul>
        <li>Kualitas kurikulum</li>
        <li>Kompetensi dosen</li>
        <li>Fasilitas pembelajaran</li>
        <li>Kualitas lulusan</li>
  ...
  },
  {
    ...
    content: `
      ...
      <ul>
        <li>Prof. Dr. dr. Ahmad, Sp.PD - Pakar Kesehatan Masyarakat</li>
        <li>Dr. Siti, M.Kes - Ahli Epidemiologi</li>
        <li>Dr. Budi, S.Kep., Ns., M.Kep - Praktisi Keperawatan Komunitas</li>
      </ul>
      
      <h2>Topik Bahasan</h2>
      <ul>
        <li>Digitalisasi pelayanan kesehatan</li>
        <li>Pencegahan penyakit menular</li>
        <li>Promosi kesehatan masyarakat</li>
        <li>Peran tenaga kesehatan dalam era digital</li>
      </ul>
      
      <h2>Peserta</h2>
      <p>Seminar diikuti oleh lebih dari 300 peserta yang terdiri dari dosen, mahasiswa, praktisi kesehatan, dan masyarakat umum. Acara ini menjadi ajang diskusi dan sharing pengetahuan tentang perkembangan terbaru dalam bidang kesehatan masyarakat.</p>
    `,
    image: 'https://images.pexels.com/photos/267885/pexels-photo-267885.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop',
    tags: ['Seminar', 'Kesehatan Masyarakat', 'Era Digital']
  }
]
