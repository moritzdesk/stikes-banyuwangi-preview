          ...
          <div class="text-center">
            ...
            <div class="flex gap-4 justify-center">
              <a 
                ...
                target="_blank"
                class="inline-flex items-center px-6 py-3 bg-[#195682] text-white font-bold rounded-full hover:bg-[#0b2b42] transition-colors shadow-md hover:shadow-lg"
              >
...
const magazines = computed(() => (initialMagazines.magazines || []).slice(0, 4))
